...
classes = ('LeoWalk', 'Point_in_air', 'Scooby_Doo')
...
for e in range(epochs):
    ...
    if e%2 == 0:
        ...
        if val_loss < best_val:
            best_val = val_loss
            PATH = '../../models/Locking_1kepochs_cnn.pth'
...
plt.ylabel("Loss")
plt.legend()
fig.savefig('Locking_Losses_10kepochs.png')
...
plt.ylabel("Acc.")
plt.legend()
fig.savefig('Locking_Accuracy_10kepochs.png')